...
### Главный экран
![Главный экран калькулятора](./screenshots/main.png)

### Пример вычисления: 5 + 3 = 8
![Пример сложения](./screenshots/example-calculate.png)

### Кнопка удаления (DEL)
![Удаление последнего символа](./screenshots/delete-example.png)
